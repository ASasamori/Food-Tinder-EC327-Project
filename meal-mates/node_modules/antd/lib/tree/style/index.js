...
var genBaseStyle = function genBaseStyle(prefixCls, token) {
  ...
  }), (0, _defineProperty2["default"])(_extends2, treeCls + "-node-content-wrapper, " + treeCls + "-checkbox + span", {
    paddingInline: 0
  }), (0, _defineProperty2["default"])(_extends2, treeCls + "-node-content-wrapper", (_ref8 = {
    display: 'flex',
    flexWrap: 'nowrap',
    position: 'relative',
    zIndex: 'auto',
